...
public class RateMoreRecentlyProductsMongoOutputFormat implements OutputFormat<Row> {
    ...
    public void writeRecord(Row row) throws IOException {
        ...
        MongoCollection<Document> collection = mongoDatabase.getCollection("RateMoreRecentlyProducts");
        //插入文档
        Document document = new Document("productId", row.getField(0))
                .append("countNum", row.getField(1))
                .append("yearmonth", row.getField(2));
