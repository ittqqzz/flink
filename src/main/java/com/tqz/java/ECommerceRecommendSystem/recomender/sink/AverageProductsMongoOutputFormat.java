...
public class AverageProductsMongoOutputFormat implements OutputFormat<Row> {
    ...
    public void writeRecord(Row row) throws IOException {
        ...
        MongoCollection<Document> collection = mongoDatabase.getCollection("AverageProducts");
        //插入文档
        Document document = new Document("productId", row.getField(0))
                .append("scoreAvg", row.getField(1));
